...
#define STRING_VERSION_CONFIG_H "2012-09-02" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "roger" //Who made the changes.
...
#define PID_MAX 255 // limits current to nozzle; 255=full current
  ...
  #define K1 0.99 //smoothing factor withing the PID
  #define K1_INT 9 //smoothing factor withing the PID
...
// Guesstimated PID based on using above ultimaker defaults.
...
const bool Y_ENDSTOPS_INVERTING = true; // set to true to invert the logic of the endstops. (Try to ignore Y as we are doing this using L6470 now)
