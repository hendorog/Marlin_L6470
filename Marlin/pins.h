...
#define X_STEP_PIN         54 // 1
#define X_DIR_PIN          55 // Not needed - L6470
#define X_ENABLE_PIN       38 // 2
#define X_MIN_PIN           3 // 3
#define X_MAX_PIN           2 // Not needed - single endstops         //2 //Max endstops default to disabled "-1", set to commented value to enable.

#define Y_STEP_PIN         60 // 4
#define Y_DIR_PIN          61 // Not needed - L6470
#define Y_ENABLE_PIN       56 // 5
#define Y_MIN_PIN          14 // 6
#define Y_MAX_PIN          15 // Not needed - single endstops         //15

#define Z_STEP_PIN         46 // 7
#define Z_DIR_PIN          48 // Not needed - L6470
#define Z_ENABLE_PIN       62 // 8
#define Z_MIN_PIN          18 // 9
#define Z_MAX_PIN          19 // Not needed - single endstops

#define Z2_STEP_PIN        36 // Not needed - Single Z driver
#define Z2_DIR_PIN         34 // Not needed - Single Z driver
#define Z2_ENABLE_PIN      30 // Not needed - Single Z driver

#define E0_STEP_PIN        26 // 10
#define E0_DIR_PIN         28 // Not needed - L6470
#define E0_ENABLE_PIN      24 // 11

#define E1_STEP_PIN        36 // Not needed - single extruder
#define E1_DIR_PIN         34 // Not needed - single extruder 
#define E1_ENABLE_PIN      30 // Not needed - single extruder

#define SDPOWER            -1 // Not needed - no SDCard support
#define SDSS               53 // Not needed - no SDCard support
#define LED_PIN            13 // Don't count - built in
...
#define KILL_PIN           -1
  ...
  #define HEATER_0_PIN      48    // RAMPS 1.1
...
#define TEMP_1_PIN          2   // only used for testing - pin 1 has a pullup resistor, pin 0 and pin 2 have not.
#define TEMP_2_PIN          0   // only used for testing - pin 1 has a pullup resistor, pin 0 and pin 2 have not.   
#define TEMP_BED_PIN        -1    // MUST USE ANALOG INPUT NUMBERING NOT DIGITAL OUTPUT NUMBERING!!!!!!!!!

//#define SS               53  // Wire this to the CSN pin
//#define MOSI             51  // Wire this to the SDI pin
//#define MISO             50  // Wire this to the SDO pin
//#define SCK              52  // Wire this to the CK pin
#define L6470_SS               53  // Wire this to the CSN pin
#define L6470_MOSI             51  // Wire this to the SDI pin
#define L6470_MISO             50  // Wire this to the SDO pin
#define L6470_SCK              52  // Wire this to the CK pin
