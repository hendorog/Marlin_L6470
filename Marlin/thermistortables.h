...
#if (THERMISTORHEATER_0 == 77) || (THERMISTORHEATER_1 == 77) || (THERMISTORHEATER_2 == 77) || (THERMISTORBED == 77) //100k honeywell thermistor with 5600 pullup
const short temptable_77[][2] PROGMEM = {
   {1*OVERSAMPLENR, 857},
   {54*OVERSAMPLENR, 252},
   {107*OVERSAMPLENR, 205},
   {160*OVERSAMPLENR, 180},
   {213*OVERSAMPLENR, 163},
   {266*OVERSAMPLENR, 149},
   {319*OVERSAMPLENR, 138},
   {372*OVERSAMPLENR, 128},
   {425*OVERSAMPLENR, 120},
   {478*OVERSAMPLENR, 112},
   {531*OVERSAMPLENR, 104},
   {584*OVERSAMPLENR, 97},
   {637*OVERSAMPLENR, 89},
   {690*OVERSAMPLENR, 82},
   {743*OVERSAMPLENR, 74},
